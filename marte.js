...
(function() {
    ...
    // =========================================================================
    // 3. CORE FUNCTIONS (Defined at top to avoid Hoisting errors)
    // =========================================================================
    ...
    function processGame(node) {
        ...
        // Inject Buttons
        // Supports both Homepage and Search pages
    ...
    // =========================================================================
    // 5. SILENT LOADER (Universal)
    // =========================================================================

    function findMainGrid() {
        // Universal heuristic: Find the parent with the most game cells
